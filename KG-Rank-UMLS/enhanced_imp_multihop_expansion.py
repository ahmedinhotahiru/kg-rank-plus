...
def get_umls_keys(query, answer, prompt, llm):
    ...
    max_relations_to_keep = {
        ...
        2: 50,   # Keep top 50 2-hop relations (increased from 50)
        3: 30    # Keep top 30 3-hop relations (increased from 20)
    }
    ...
    for key in entities:
        ...
        first_hop_relations = umls_api.get_relations(cui)
        ...
        # Sort first-hop relations by score
        ...
        for hop_level in range(2, max_hops + 1):
            ...
            # Select top relations at this hop level
            top_for_this_hop = min(len(hop_relations), max_relations_to_keep[hop_level])
            selected_hop_relations = hop_relations[:top_for_this_hop]
            
            # Add selected relations to all_relations
        ...
        top_relations = all_scores[:max_top_relations]
